      ...
      <section className="section-box">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="text-4xl font-bold text-[#f0d080]">Companion Crafter</h1>
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[#8f7635]">
      ...
      <section className="section-box">
        ...
        {characters.length === 0 ? (
          <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
            <div className="text-4xl text-[#b8962e]">⚔</div>
            <div className="text-xl font-bold text-[#f0d080]">No characters yet</div>
            <div className="max-w-xl text-sm leading-6 text-[#8f7635]">
          ...
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-2 2xl:grid-cols-3">
            {characters.map(character => (
              <div key={character.id} className="section-box border-[#5a4a1b]">
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0">
                    <div className="truncate text-2xl font-bold text-[#f0d080]">
                      {character.name || 'Unnamed'}
                    </div>
                    <div className="mt-2 text-sm leading-6 text-[#c8a84b]">
                      {[character.race, character.classAndLevel, character.background].filter(Boolean).join(' · ') || 'No details yet'}
                    </div>
                  </div>

                  <div className="rounded border border-[#2a1f00] px-3 py-2 text-right">
                    <div className="text-lg font-bold text-[#f0d080]">{character.armorClass}</div>
