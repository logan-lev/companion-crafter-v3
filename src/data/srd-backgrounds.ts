...
export const HERMIT_LIFE_OF_SECLUSION = [
...
export const NOBLE_VARIANT_OPTIONS = ['Normal Noble', 'Knight Variant'];
export const NOBLE_TITLE_OPTIONS = [
  'Baron or Baroness',
  'Count or Countess',
  'Duke or Duchess',
  'Lord or Lady',
...
export const NOBLE_FAMILY_DETAIL_OPTIONS = [
  'My family is old and established, with deep roots in the region.',
  'My family gained its title recently and still fights for recognition.',
  'My house is wealthy and influential, with land, taxes, and political reach.',
  'My house has fallen from favor or carries a public scandal.',
  'My family is beloved by common folk for protection and generosity.',
  'My family is feared or resented for harsh rule and privilege.',
  'I am close to inheritance and carry real expectations from my house.',
  'I am far from inheritance and must make my own name in the world.',
];
export const NOBLE_RETAINERS_DESCRIPTION = 'You have the service of three retainers loyal to your family. These attendants can perform ordinary tasks for you, such as carrying messages, arranging meals, tending equipment, or maintaining your noble appearance, but they do not fight for you, follow you into obvious danger, or serve as adventuring companions. If you are a knight, one retainer may be a squire who serves you while learning the path of knighthood.';
export const OUTLANDER_ORIGINS = [
  'Forester',
  'Trapper',
  'Homesteader',
  'Guide',
...
export const SAILOR_VARIANT_OPTIONS = ['Normal Sailor', 'Pirate Variant'];
export const SAILOR_LUCKY_CHARMS = [
  "Rabbit's foot",
  'Small stone with a hole in the center',
  'Scrap of sailcloth from your first ship',
  'Bent coin from a distant port',
  'Carved bone charm',
  'Pressed flower from shore leave',
];
export const SAILOR_BAD_REPUTATION_DESCRIPTION = 'No matter where you go, people are afraid of you due to your reputation. When you are in a civilized settlement, you can get away with minor criminal offenses, such as refusing to pay for food at a tavern or breaking down doors at a local shop, since most people will not report your activity to the authorities.';
export const SOLDIER_SPECIALTIES = [
  'Officer',
  'Scout',
  'Infantry',
  'Cavalry',
...
export const SOLDIER_RANKS = [
  ...
  'Captain',
  'Commander',
  'Custom military rank',
];
export const URCHIN_PARENT_TOKENS = [
  'Worn locket',
  'Scrap of a letter',
  'Bent copper ring',
  'Faded ribbon',
...
export const URCHIN_CITY_DETAILS = [
  'A cramped port district full of sailors, smugglers, and market stalls.',
  'A noble ward where servants, guards, and discarded finery taught me how wealth moves.',
  'A temple district where charity, bells, and secrets shaped my childhood.',
  'A crowded market quarter where every alley had a price and every face had a story.',
  'A ruined or neglected district where children learned to disappear quickly.',
  'A city gate neighborhood where caravans, refugees, and rumors never stopped arriving.',
];
export const BACKGROUND_DATA: BackgroundData[] = [
  ...
  },
  {
    ...
    languages: 1,
    equipment: 'Scroll case stuffed with notes from your studies or prayers, winter blanket, common clothes, herbalism kit, 5 gp',
    ...
    flavorChoiceLabel: 'Life of Seclusion',
    flavorChoiceOptions: HERMIT_LIFE_OF_SECLUSION,
  ...
  },
  {
    ...
    flavorText: "You grew up in the wilds, far from civilization and the comforts of town and technology. You've witnessed the migration of herds larger than forests, survived weather more extreme than any city-dweller could comprehend, and enjoyed the solitude of being the only thinking creature for miles in any direction. The wilds are in your blood, whether you were a nomad, an explorer, a recluse, a hunter-gatherer, or even a marauder. Even in places where you don't know the specific features of the terrain, you know the ways of the wild.",
    flavorChoiceLabel: 'Origin',
    flavorChoiceOptions: OUTLANDER_ORIGINS,
  ...
  },
  {
    ...
    toolProfs: [],
    languages: 2,
    equipment: 'Bottle of black ink, quill, small knife, a letter from a dead colleague posing a question you have not yet been able to answer, common clothes, 10 gp',
    ...
    flavorChoiceLabel: 'Specialty',
    flavorChoiceOptions: SAGE_SPECIALTIES,
  ...
  },
  {
    ...
    equipmentChoiceLabel: 'Choose your lucky charm',
    equipmentChoiceOptions: SAILOR_LUCKY_CHARMS,
    ...
    flavorText: 'You sailed on a seagoing vessel for years. In that time, you faced down mighty storms, monsters of the deep, and those who wanted to sink your craft to the bottomless depths. Your first love is the distant line of the horizon, but the time has come to try your hand at something new. Discuss the nature of the ship you previously sailed with your Dungeon Master. Was it a merchant ship, a naval vessel, a ship of discovery, or a pirate ship? How famous (or infamous) is it? Is it widely traveled? Is it still sailing, or is it missing and presumed lost with all hands? What were your duties on board-boatswain, captain, navigator, cook, or some other position? Who were the captain and first mate? Did you leave your ship on good terms with your fellows, or on the run?',
  ...
  },
  {
    ...
    flavorText: "War has been your life for as long as you care to remember. You trained as a youth, studied the use of weapons and armor, learned basic survival techniques, including how to stay alive on the battlefield. You might have been part of a standing national army or a mercenary company, or perhaps a member of a local militia who rose to prominence during a recent war. When you choose this background, work with your DM to determine which military organization you were a part of, how far through its ranks you progressed, and what kind of experiences you had during your military career. Was it a standing army, a town guard, or a village militia? Or it might have been a noble's or merchant's private army, or a mercenary company.",
    flavorChoiceLabel: 'Specialty',
    flavorChoiceOptions: SOLDIER_SPECIALTIES,
  ...
  },
  {
    ...
    equipmentChoiceLabel: 'Choose your token to remember your parents by',
    equipmentChoiceOptions: URCHIN_PARENT_TOKENS,
